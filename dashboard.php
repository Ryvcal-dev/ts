...
<body>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			<!--	<h1><marquee behavior=alternate direction="right" width="850"  scrollamount="2"><span style="color: green">Total Earnings till Date : Rs.<?php include 'actions/income-count.php'?>  */
		   </span>      |       <span style="color: red"> Pending Payment : Rs.<?php include 'actions/pendingpayment.php'?></span> -->
