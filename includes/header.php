...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/all.png">
...
<nav class="navbar navbar-custom navbar-fixed-top bg-info" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?dashboard"><img src="assets/img/all.png" width="190px"></a>
