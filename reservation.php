                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price"><span> 00</span> </span></h4>
                                </div>
                            </div>
                        </div>
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold">Price: <span id="price">0</span> /Days</h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price"><span>00</span> </span>Ribu Rupiah </h4>
                                </div>
                            </div>
                        </div>
                    <?php }
